...
transformation_operators = {
    ...
    'cpp': {
        'stdc++': (rec_Include, cvt_AddBitsStd),
        'namespace': (rec_NameSpaceStd, cvt_AddStd),
        'sync_with_false': (rec_MainWithoutSync, cvt_AddSyncWithFalse),
        'struct': (rec_StructDeclare, cvt_DelStruct),
        'coutendl': (rec_Printf, cvt_Printf2CoutEndl),
